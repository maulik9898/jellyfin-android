...
class CustomLoadControl protected constructor(
     ...
     * Constructs a new instance, using the `DEFAULT_*` constants defined in this class.
     */
    constructor(listener: EventListener?) : this(DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE)) {
...
//        }
    ...
    private fun computeIsBuffering(bufferedDurationUs: Long) {
        ...
        val targetBufferSizeReached = allocator.totalBytesAllocated >= targetBufferBytes
        isBuffering = if (bufferTimeState == BELOW_LOW_WATERMARK) {
            true
    ...
    private fun printBufferTimeState(value: Int): String {
//        private static final int ABOVE_HIGH_WATERMARK = 0;
//        private static final int BETWEEN_WATERMARKS = 1;
//        private static final int BELOW_LOW_WATERMARK = 2;
        when (value) {
            0 -> return "ABOVE_HIGH_WATERMARK"
            1 -> return "BETWEEN_WATERMARKS"
            2 -> return "BELOW_LOW_WATERMARK"
        }
        return ""
    }

    override fun shouldStartPlayback(
        bufferedDurationUs: Long, playbackSpeed: Float, rebuffering: Boolean, a: Long
    ): Boolean {
    ...
    companion object {
         ...
         */
        const val DEFAULT_MAX_BUFFER_MS = 200000
         ...
         */
        const val DEFAULT_MIN_BUFFER_SIZE = 200 * C.DEFAULT_BUFFER_SEGMENT_SIZE * 2
